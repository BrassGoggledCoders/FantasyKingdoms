...
public class BlockFluidBeer extends BlockFluidClassic
{
	...
	public BlockFluidBeer(Fluid fluid, Material material)
	{
	...
	{
		this.blockIcon = iconRegister.registerIcon("dwarvenkingdoms:" + "beerStill");
		iconFlowing = iconRegister.registerIcon("dwarvenkingdoms:" + "beerFlowing");
	}
