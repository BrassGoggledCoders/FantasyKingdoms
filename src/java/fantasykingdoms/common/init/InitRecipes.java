...
public class InitRecipes
{
	public static void init()
	{
		...
		RecipeUtils.addToolSet(new ItemStack(InitItems.itemIngot, 1, 2), new ItemStack[] { new ItemStack(InitItems.itemSilverPickaxe),
				new ItemStack(InitItems.itemSilverShovel), new ItemStack(InitItems.itemSilverAxe), new ItemStack(InitItems.itemSilverHoe),
