...
public class ItemGem extends BaseItemWithMetadata
{
	...
	{
		this.itemIcon[0] = ir.registerIcon(Reference.MODID + "itemRuby");
		this.itemIcon[1] = ir.registerIcon(Reference.MODID + "itemSapphire");
		this.itemIcon[2] = ir.registerIcon(Reference.MODID + "itemAmethyst");
	}
